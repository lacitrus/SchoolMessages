...
app.config.update(
    ...
    MAIL_USE_TLS = True,
    MAIL_USE_SSL = False,
    MAIL_USERNAME = 'rayn888@gmail.com',
    MAIL_PASSWORD = 'djzalvlapbsgdnff'
)

mail = Mail(app)
app.config['DEBUG'] = True
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://school:school@localhost:8889/school'
app.config['SQLALCHEMY_ECHO'] = True
db = SQLAlchemy(app)
app.secret_key = '77#zQqCgS3LW4W'
